...
export default function CTASection({ onBookTuning }: CTASectionProps) {
  ...
  return (
    <section className='py-12 xs:py-16 sm:py-20 md:py-24 lg:py-32 px-4 xs:px-6 sm:px-8 lg:px-12 bg-distress relative overflow-hidden'>
      ...
      <div className='relative z-10 max-w-6xl mx-auto text-center px-4 sm:px-6'>
        ...
        >
          ...
          <motion.h2
            className='text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-4 xs:mb-6 sm:mb-8 relative'

...
const features = [
  {
    ...
    description: "Advanced ECU remapping and engine optimization to maximize your motorcycle's potential. Our certified technicians use state-of-the-art diagnostic equipment to deliver measurable performance gains.",
    details: [
  ...
  },
  {
    ...
    description: "Tailored modifications designed specifically for your riding style and performance goals. From engine builds to suspension upgrades, we create solutions that fit your exact needs.",
    details: [
  ...
  },
  {
    ...
    description: "Transform your motorcycle's appearance with professional paint work, custom graphics, and premium accessories. Every detail is crafted to reflect your personal style and brand.",
    details: [
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Our comprehensive approach combines <span className="text-orange-500 font-semibold">technical expertise</span>, <span className="text-blue-500 font-semibold">custom solutions</span>, and <span className="text-orange-500 font-semibold">quality craftsmanship</span> to deliver exceptional results.
          </p>
        </motion.div>
          ...
          <Card className="glass-morphism border-0 max-w-6xl mx-auto overflow-hidden">
            ...
            <CardContent className="relative z-10 p-12">
              ...
              <p className="text-xl text-gray-300 leading-relaxed max-w-4xl mx-auto">
                <span className="text-accent font-bold">Speed</span>, <span className="text-accent font-bold">Power</span>, and <span className="text-accent font-bold">Fearless Design</span>—these are the three elements that make a DreadBike 
                unstoppable. We don&apos;t just modify motorcycles; we forge mechanical weapons that were 
                designed to dominate the road and strike fear into the hearts of ordinary riders.
              </p>
            </CardContent>
          </Card>
        </motion.div>

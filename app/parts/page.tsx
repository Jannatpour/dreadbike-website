...
const partCategories = [
  {
    ...
    items: ['Pistons', 'Camshafts', 'Valves', 'Gaskets'],
    image:
  ...
  },
  {
    ...
    icon: Zap,
    description: 'Premium exhaust systems for better performance',
    items: ['Headers', 'Mufflers', 'Catalytic Converters', 'Pipes'],
    image:
  ...
  },
  {
    ...
    name: 'Suspension',
    icon: Shield,
    description: 'Advanced suspension components for smooth rides',
    items: ['Shocks', 'Springs', 'Struts', 'Bushings'],
    image:
  ...
  },
  {
    ...
    name: 'Brake Systems',
    icon: Gauge,
    description: 'High-performance braking components',
    items: ['Brake Pads', 'Rotors', 'Calipers', 'Lines'],
    image:
      'https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    items: ['Ignition', 'Lighting', 'Batteries', 'Wiring'],
    image:
      'https://images.unsplash.com/photo-1571068316344-75bc76f77890?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Body & Frame',
    icon: Wrench,
    description: 'Structural and aesthetic components',
    items: ['Fairings', 'Frames', 'Tanks', 'Seats'],
    image:
      'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=800&h=600&fit=crop',
    ...
    <div className='min-h-screen bg-gray-900 text-white'>
      ...
      <section className='relative py-20 px-4 overflow-hidden mt-16'>
        ...
        <div
          ...
          style={{
            backgroundImage:
              'url(https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=1920&h=1080&fit=crop)',
          }}
        />
        ...
        <div className='relative max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto'>
              High-performance motorcycle parts and components for the ultimate
              riding experience
            </p>
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-gray-400 text-lg'>
              Find the perfect parts for your motorcycle
            </p>
          </motion.div>
      ...
      <section className='py-16 px-4 bg-gray-800/50'>
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-gray-400 text-lg'>
              Top-rated components from our collection
            </p>
          </motion.div>
            ...
            {featuredParts.map((part, index) => (
              ...
              >
                ...
                <div className='p-6'>
                  ...
                  <Link href={`/shop/product/${part.id}`}>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Our experts can help you find the perfect parts for your specific
              motorcycle model
            </p>
